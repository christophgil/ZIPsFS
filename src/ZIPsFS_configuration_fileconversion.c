...
_test_malloc_fail={    x(),.ext=".ls-fails.txt",     .out=STDOUT_TO_OUTFILE,.cmd={"ls","-l","not exist"},},  /* Fails with  Operation not permitted */
  ...
  _test_textbuf={      x(),.ext=".textbuf.txt",                            .cmd={NULL}}; /* See config_fileconversion_run() */
#undef x
...
/////////////////////////////////////////////////////////////////////////
static void *config_fileconversion_modify_exec_args(const char *cmd[FILECONVERSION_ARGV+1],const struct fileconversion_files *ff){
  return cmd;
}
////////////////////////////////////////////////////////////////////////////////////////////
