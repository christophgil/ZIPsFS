...
(global-set-key (kbd "<f4>") '(lambda() (interactive) (find-file "~/git_projects/common/ht4.c")))
    (global-set-key (kbd "<f5>") '(lambda() (interactive) (find-file "~/git_projects/ZIPsFS/src/log.c")))
