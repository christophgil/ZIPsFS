(progn
(global-set-key (kbd "<f1>") '(lambda() (interactive) (find-file "~/git_projects/ZIPsFS/src/ZIPsFS.c")))
        (global-set-key (kbd "<f2>") '(lambda() (interactive) (find-file "~/git_projects/cache_readdir_stat/cache_readdir_stat.c")))
(global-set-key (kbd "<f4>") '(lambda() (interactive) (find-file "~/git_projects/ZIPsFS/src/cg_mstore_v2.c")))
    (global-set-key (kbd "<f5>") '(lambda() (interactive) (find-file "~/git_projects/ZIPsFS/src/cg_ht_v5.c")))
        (global-set-key (kbd "<f6>") '(lambda() (interactive) (find-file "~/git_projects/ZIPsFS/src/configuration.h")))


        (use-package afternoon-theme) (load-theme  'afternoon)
        )
...
* Errors
mit old store:
ls -l  ~/tmp/ZIPsFS/mnt/6600-tof2/Data/30-0001/
zpath_zip_open() muss nach fhdata
...
** fuse extensions
xfuse https://www.usenix.org/system/files/atc21_slides_huai.pdf
...
* Optimization
https://www.codee.com/flexibility-and-performance-introduction-to-loop-unswitching/
...
O_DIRECT: You can add support for this yourself, without modifying libzip, by creating a custom source via zip_source_function_crreate() and passing that source to zip_open_from_source().
libzip (-lzip)
...
* Statistics
** No cache
# [106:25] Log saved to /no_raid/Users/cgille/tmp/ZIPsFS/diann/test/report.log.txt
# Finished

** cache tdf
# [103:36] Log saved to /no_raid/Users/cgille/tmp/ZIPsFS/diann/test/report.log.txt
# Finished
              Event                 Count
readzip_cached                       50,987
readzip_regular                   1,256,113
readzip_seekable_fwd                107,538
readzip_seekable_bwd                  6,597
readzip_no_seek                   1,141,965
readzip_seek_fwd                          0
readzip_cache_because_seek_bwd            0
readzip_reopen_because_seek_bwd           0
close_later                               0
ax_size                             131,072

** cache tdf_bin

zipfile_name_to_display_name
RECOGNIZE_ZIP_FILES_1

** cache tdf and tdf_bin
[108:03] Log saved to /no_raid/Users/cgille/tmp/ZIPsFS/diann/test/report.log.txt
Finished

* Fehler:
 - dir->filenames_l+=len1;
 - LOCK UNLOCK braces
 - zip_open zip_close braces
 - init_stat(&st,(f2.opt&DIRENT_ISDIR)?-1:f.size,&zpath->stat_rp);
...
Cache tdf_bin
[64:24] File #30/30
[66:27] Cross-run analysis
*** Repeat
  [31:34] File #17/30

** mmap
[61:56] Cross-run analysis
[111:45] Log saved to /no_raid/Users/cgille/tmp/ZIPsFS/diann/test/report.log.txt




                         Path                           Writable Response Delayed Free[GB] Cache[kB]
                         /home/cgille/tmp/ZIPsFS/modified                          Yes       Local                0         0
                         /slow2/incoming                                            No        0 ms       0    1,385     3,737
                         /s-mcpb-ms03.charite.de/fularchiv01.d/EquiValent/152/1     No        0 ms       0  298,018     5,290
...
https://linux.die.net/man/2/fadvise
    const int pos=
    https://www.dell.com/support/kbdoc/de-de/000140396/5-wege-die-festplattengeschwindigkeit-unter-linux-zu-verbessern
