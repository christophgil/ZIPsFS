...
as=''
if false;then
    gcc -DHAVE_CONFIG_H -I. -I/usr/include/fuse3/ -I/usr/local/include/fuse3 -O0 -D_FILE_OFFSET_BITS=64 -rdynamic -ggdb  $dir/ZIPsFS.c -lfuse3 -lpthread -L/usr/local/lib -lm -lzip -o $dir/ZIPsFS
else
