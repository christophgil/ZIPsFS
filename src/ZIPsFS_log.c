...
#undef A
	  ...
	  C(ROOT_PROPERTY_PATH_DENY,"%s",tmp);

	  if (r) cg_str_join(tmp,22,30,(const char**)r->starts_vp, ":");
	  C(ROOT_PROPERTY_PATH_ALLOW,"%s",tmp);
  ...
  P("Explain table:\n"
	...
	"         "ROOT_PROPERTY_PATH_ALLOW"  Possible path beginnings. Separated by colon.\n\n"
	"         "ROOT_PROPERTY_PATH_DENY"   Forbidden filepaths. Separated by colon.\n\n\n\
