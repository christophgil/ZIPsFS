...
#define I "echo 'With this script, the last last-access time of files in ZIPsFS can be changed. Files that do not exist yet are generated.'\n\
...
for f in $ff;do echo \""ANSI_FG_BLUE"\"Processing $f ...\""ANSI_RESET"\"; head \"$f\"|head -n 3|strings;ls \"$f\""MAGIC_SFX_SET_ATIME"$h; cat $f.log; done\n");
    break;
...
/* #if WITH_AUTOGEN */
/*     else{ */
/*       autogen_zpath_init(zpath,path2); */
/*       struct fhdata d; */
/*       fhdata_init(&d,zpath); */
/*       LOCK(mutex_autogen,autogen_run(&d)); */
/*     } */
/* #endif //WITH_AUTOGEN */
  }/*posHours*/
  return false;
