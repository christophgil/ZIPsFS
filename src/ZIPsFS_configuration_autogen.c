...
#define x()  .ends=".txt",.patterns={"test_autogen"},.estimated_filesize=99
struct autogen_rule
_test_malloc_fail={    x(),.ext=".ls-fails.txt",     .out=STDOUT_TO_OUTFILE,.cmd={"ls","-l","not exist"},},  /* Fails with  Operation not permitted */
  ...
  _test_mmap={         x(),.ext=".mmap.txt",         .out=STDOUT_TO_MMAP,.  cmd={"echo","Hello"},},
  _test_noext={        x(),.ext=".mmap.noext.TXT",   .out=STDOUT_TO_MMAP,.  cmd={"echo","Hello"},.generated_file_hasnot_infile_ext=true,.fsize_is_multiple_of_infile=true},
  _test_textbuf={      x(),.ext=".textbuf.txt",                            .cmd={NULL}}; /* See config_autogen_run() */
#undef x
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Return true to not generate a file using this virtual path and this rule                            ///
///////////////////////////////////////////////////////////////////////////////////////////////////////////
static bool config_autogen_exclude(const char *vp, const int vp_l,const struct autogen_rule *ac){
  return false;
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////
static void *config_autogen_modify_exec_args(const char *cmd[AUTOGEN_ARGV+1],const struct autogen_files *ff){
  return cmd;
}
////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////
/// Filecontent can be generated by a C-function rather than by running an external command.     ///
////////////////////////////////////////////////////////////////////////////////////////////////////
static enum enum_autogen_run_res config_autogen_run(struct autogen_files *ff){
  if (ff->rule==&_test_textbuf){ /* This example shows how file content is generated without calling an external program. */
    ...
    */
    ...
    if (C(ff,t,strlen(t))) return AUTOGEN_RUN_FAIL;
    t="This text is in the heap storage. It should be released with free().\n";
    if (H(ff,strdup(t),strlen(t))) return AUTOGEN_RUN_FAIL;
