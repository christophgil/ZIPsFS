...
// README_AUTOGENERATED.TXT
#if !WITH_PRELOADFILERAM && (WITH_CCODE||WITH_INTERNET_DOWNLOAD||WITH_AUTOGEN)
#warning "Since WITH_PRELOADFILERAM is 0, other in the config activated features will also be deactivated"
#undef WITH_CCODE
#undef WITH_INTERNET_DOWNLOAD
#undef WITH_AUTOGEN
#define WITH_CCODE 0
#define WITH_INTERNET_DOWNLOAD 0
...
#define DIR_PRELOADED_BY_ROOT    DIR_ZIPsFS"/.preloaded_by_root"     /* For roots with --preload */
#define DIR_PRELOADED_BY_PATH    DIR_ZIPsFS"/.preloaded_by_path"   /* For virtualpath starting with DIR_PRELOADFILEDISK_RZ ...  */
...
#define DEF_SPECIAL_FILES C(SFILE_INFO,0,"file_system_info.html")\
  ...
  C(SFILE_SET_ATIME_BAT,0,FILENAME_SET_ATIME".bat")\
       ...
       C(SFILE_README_AUTOGEN,         SFILE_FLAG_OTHER_DIR,           "README_ZIPsFS.TXT")
...
#define PATH_STARTS_WITH(vp,vp_l,dir)         (((vp_l)>sizeof(dir) && (vp)[sizeof(dir)-1]=='/' &&  STARTSWITH((vp),dir)))
#define    PATH_STARTS_Z(vp,vp_l,dir,dir_l)   (((vp_l)>dir_l+1 && (vp)[DIR_ZIPsFS_L]=='/' &&  (vp)[dir_l]=='/' && STARTSWITH((vp),dir)))

#define       STR_EQUALS(vp,vp_l,s)           (((vp_l)==sizeof(s)-1&&!memcmp((vp),s,sizeof(s)-1)))
#define      VP_STARTS_Z(dir)                  PATH_STARTS_Z((vp),(vp_l),dir,sizeof(dir)-1)
#define        VP_STARTS(dir)                  PATH_STARTS_WITH((vp),(vp_l),dir)
#define          VP_EQ_Z(dir)                  (((vp_l)==sizeof(dir)-1 && (vp)[DIR_ZIPsFS_L]=='/' && !memcmp((vp),dir,sizeof(dir)-1)))
