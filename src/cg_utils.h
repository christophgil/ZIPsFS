...
#define GREEN_SUCCESS ANSI_GREEN ANSI_FG_WHITE" SUCCESS "ANSI_RESET
#define GREEN_ALREADY_EXISTS ANSI_GREEN ANSI_FG_WHITE" Already exists "ANSI_RESET
#define GREEN_DONE ANSI_GREEN ANSI_FG_WHITE" DONE "ANSI_RESET
#define RED_WARNING ANSI_RED ANSI_FG_WHITE" WARNING "ANSI_RESET

#define RED_FAIL ANSI_RED ANSI_FG_WHITE" FAIL "ANSI_RESET
#define RED_ERROR ANSI_RED ANSI_FG_WHITE" ERROR "ANSI_RESET
